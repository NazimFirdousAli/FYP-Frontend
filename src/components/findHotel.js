...
const API_KEY = 'AIzaSyADmNrx-v8o-go9raKrbO4An9RaYGfUW9s';
    ...
    geocoder.geocode({ address: address }, (results, status) => {
      if (status === 'OK') {
        ...
        try {
          ...
          axios
            .get(
              `https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/nearbysearch/json?key=AIzaSyADmNrx-v8o-go9raKrbO4An9RaYGfUW9s&radius=5000&type=lodging&pagetoken=&location=${this.state.Lat},${this.state.Lng}&keyword=Hotel&rankby=prominence`,
              {
                headers: {
                  'Access-Control-Allow-Origin': '*',
                  'Access-Control-Allow-Headers': 'Content-Type, Authorization',
