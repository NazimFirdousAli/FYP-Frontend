...
export default class Manualselecthotels extends Component {
    ...
    async componentDidMount() {
        ...
        Geocode.setApiKey("AIzaSyADmNrx-v8o-go9raKrbO4An9RaYGfUW9s");
        ...
        axios
            .get(
...

                {
                    method: 'GET',
                    params: {
                        //https://travel-advisor.p.rapidapi.com/hotels/list?offset=0&currency=PKR&limit=30&order=asc&lang=en_US&sort=recommended&location_id=${this.state.Lat}%252C${this.state.Lng}&adults=1&checkin=2020-12-31&rooms=1&nights=2&maxResults=24
                        location_id: `${this.state.Lat}%252C${this.state.Lng}`,
                        adults: '1',
                        rooms: '1',
                        nights: '2',
                        offset: '0',
