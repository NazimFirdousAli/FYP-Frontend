...
class Manualcheckroute extends Component {
    ...
    async componentWillMount() {
        ...
        axios
            .get(`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${destination}+point+of+interest&language=en&key=AIzaSyADmNrx-v8o-go9raKrbO4An9RaYGfUW9s`,
                {
                    headers: {
